...
public function Login()
  {
      ...
      if($res)
      {
        ...
        foreach($res as $result)
        {
    		...
    		
          {
            ...
            $this->session->set_userdata('id_tu',$result->id_tu);
    ...
    if ($this->session->userdata('logged')) {
	    ...
	    $data['title'] = "Paciente Móvel | Login";
	...
	public function Register() {
		...
		if($this->form_validation->run() == FALSE){
			...
			if ($data['error'] == NULL) {
				...
				$data['dataRegister'] = array('nome' => '', 'user' => '', 'senha' => '');	
			}
			else{
			...
			if($res){
				...
				$data['dataRegister'] = array('nome' => '', 'user' => '', 'senha' => '', 'confSenha' => '',);
