        <section>
            <div class="container">
                    <div class="row">
                        <div class="col-lg-12"> 
                             <h2 class="text-center" style="color: #560d16 !important"><i class="fa fa-user"></i> Usuários</h2>
                        </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class=" col-sm-6 text-right">
                        <a href="<?=base_url('adm/cadastro-usuario')?>" class="btn" style="background-color: #72141f; color:#fff !important">Novo Usuario <i class="fa fa-plus"></i></a>
                      </div>
                    </div>
                    <br>
                    <div class="row">
