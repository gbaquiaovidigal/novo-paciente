					...
					<div class="row">
                        ...
                        <?php endif; ?>
							...
							<form method="POST" action="<?=base_url('adm/editar-veiculo')?>">
								...
								<label for="Veiculo"><h4><strong>Nome da veiculo</strong></h4></label>
								<input type="text" class="form-control" name="veiculo" id="veiculo" required="" value="<?=$dataRegister['veiculo']?>" placeholder="Insira o nome da veiculo"> 
								</br>
